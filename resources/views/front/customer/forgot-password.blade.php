...
<head>
    ...
    <title>Hamro Dristi| Forget Password</title>
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="{{ route('customer.reset-link') }}" method="post">
                    @csrf
        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('customer.reset-link') }}">
                        @csrf
